...
export default function Modal({ show, onClose, hash, valid }) {
  const handleClose = (e) => {
    e.preventDefault();
    onClose();
  };
        ...
        <div className="w-[500px] bg-white shadow-xl rounded-lg px-6 pt-6 pb-8 mb-4">
          {valid ? (
            <div className="text-center mb-8">
              ...
              />
              <p className="text-[#353637]">
                Your document is valid with the following hash:
              </p>
              <p className="text-sm text-[#353637] font-bold">{hash}</p>
            </div>
          ) : (
            <div className="text-center mb-8">
              <h3 className="text-3xl font-bold text-[#353637]">
              ...
              />
              <p className="text-[#353637]">Your document is invalid</p>
            </div>
          )}
          <div>
            <button
